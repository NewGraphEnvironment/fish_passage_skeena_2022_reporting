...
proceeding to design for replacement. Of note, at the time of reporting, due to our prioritization work, a design for a replacement structure to more effectively facilitate upstream migration for all fish life stages and species was being developed by Mark Dewit from the Ministry of Forests. In addition to replacement of the culvert with a bridge, recommendations going forward include:

  * Electrofishing and PIT tagging upstream and downstream of the FSR to provide insight into fish community composition, density, survival and movement.
