...
upstream from the confluence with the Zymoetz River. A phase 1 and phase 2 assessment was conducted on this site in 2021, and electrofishing was conducted in 2022. 
...
A total of `r fpr::fpr_my_bcfishpass(col_pull = total_lakereservoir_ha)`ha of lake and `r fpr::fpr_my_bcfishpass(col_pull = total_wetland_ha)`ha of wetland is modelled upstream. This crossing was listed as a barrier at the time of survey by @gollner2013 in 2012. Comments indicate that fish were observed downstream, and good habitat was present upstream. 
...
(Table \@ref(tab:tab-culvert-197379)). Water temperature was
...
`r fpr_my_habitat_paragraph(loc = 'us')` Bedrock dominated the stream substrate. Lots of undercut banks were present with some pools. Healthy riparian vegetation providing cover. Functional woody debris habitat with good flow. There was a large woody debris jam but there was running water underneath. The stream was  steep below the falls, cascading with pools. The habitat was rated as
...
\@ref(fig:plot-fish-box-197379). Coho were captured downstream of the crossings but not upstream. There appeared to be some rainbow and cutthroat hybrids. The stream was mostly dry at the time of electrofishing, with fish concentrated in pools. 
...
proceeding to design for replacement in 2021. A design is currently underway by Mark Dewit from MoF. 
