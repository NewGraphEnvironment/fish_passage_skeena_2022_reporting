...
Following the 2022 survey, the site was ranked as `r fpr::fpr_my_priority_info(col_pull = priority)` priority for proceeding to design for replacement, with a recommendation to conduct electrofishing to help further inform prioritization. The site was revisited September 21, 2023 and electrofishing was conducted upstream and downstream of the crossing to provide insight into fish community composition and density. Cutthroat trout and rainbow trout fry and parr were captured upstream of the crossing, but there was no dolly varden presence upstream. Additionally, juvenile and adult cutthroat trout and rainbow trout were only captured downstream of the crossing. These results suggest that crossing `r as.character(my_site)` may be a barrier to certain life stages of cutthroat trout and rainbow trout, and is a barrier to dolly varden. Due to the crossing's proximity to the Kispiox River, migration is likely limited to times of high flows when the outlet drop would be reduced, which could explain why certain life stages were not captured upstream of the crossing.
