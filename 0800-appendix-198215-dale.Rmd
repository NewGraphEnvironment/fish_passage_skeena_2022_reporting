...
upstream from the confluence with the Kispiox River. This crossing is the responsibility of the Ministry of Transportation and Infrastructure.
...
`r fpr_my_habitat_paragraph(loc = 'ds')` This stretch of stream was steep but had good habitat. There was one lock block step approximately 30m downstream of the culvert that was approximately 1m in height that could block upstream migration for non adult fish species (Figure \@ref(fig:photo-198215-02)). This was likely put in this location in the past to act as a backwatering structure and attempt to minimize the culvert outlet drop to facilitate upstream fish passage. The
...
`r fpr_my_habitat_paragraph(loc = 'us')` There were numerous cascades that were approximately 1m in height at the time of survey, with deep outlet pools. The stream channel was frequently confined and restriced from lateral migration from the valley walls. Significant amounts of large woody debris were found in and around the stream, adding complexity. There were trace amount of gravels suitable for spawning. After the first 500m of the survey, there were logs deliberately placed perpendicular to the stream at regular intervals (shown in Figure \@ref(fig:photo-198215-06)). These most likely function to capture substrate and provide complexity and spawning/rearing habitat.  The stream was surveyed to a location of a dam listed in the Canadian Aquatic Barrier Database [@canadianwildlifefederation2023CanadianAquatic]. The dam was not present but there appeared to be some remnants left (Figure \@ref(fig:photo-198215-05)).  The habitat was rated as
