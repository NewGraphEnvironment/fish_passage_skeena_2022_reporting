...
\@ref(tab:tab-wshd-198217)). Upstream of crossing
...
\@ref(tab:tab-culvert-bcfp-198217). A map of the watershed is provided in
map attachment
...
`r if(gitbook_on){knitr::asis_output("(Figures \\@ref(fig:photo-198217-03) - \\@ref(fig:photo-198217-06)).")}else(knitr::asis_output("(Figure \\@ref(fig:photo-198217-d02))."))`
