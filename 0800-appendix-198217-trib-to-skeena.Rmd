...
PSCIS crossing `r as.character(my_site)` and `r as.character(my_site2)` are located on a `r fpr::fpr_my_pscis_info()`, just outside the small
...
inlet side that could be a barrier to adult coho. The trash rack had grid sizes of approximately 13cm by 13cm (shown in Figure \@ref(fig:photo-198216-rack)).
