...
`r fpr::fpr_my_pscis_info()`, just north of the village of Kitwanga, on
`r fpr_my_pscis_info(col_pull = road_name)`. This crossing was located
`r round(fpr::fpr_my_bcfishpass(col_pull = downstream_route_measure)*0.001, 1)`km
upstream from the confluence with the Kitwanga River. PSCIS
crossing 198200 located approximately 200m upstream from 198220, on
Moore Road, was also assessed and is
discussed below. Both crossings are the responsibility of the Ministry of Transportation and Infrastructure. The highway crossing has a `chris_culvert_id` of 1528423, and the Moore Road `chris_culvert_id` is 1528424. Additionally, PSCIS crossing 198201 located on a tributary to Tea Creek on Moore Road was assessed.  
...
been recorded [@moe2020KnownBC; @norris2022smnorrisbcfishobs]. Tea Creek is a known steelhead stream, this was confirmed by a local landowner who reported historic spawning in tributaries of the highway.
...
PSCIS crossing 198201 located approximately 350m east of crossing 198200 was assessed and ranked as passable at the time of survey. There were two culverts side by side, with both embedded and non backwatered. Fish were spotted in the culverts. A summary of the assessment is shown in Table
\@ref(tab:tab-culvert-8300917).
...
`r fpr_my_habitat_paragraph(loc = 'us')` Only a few areas contained gravels suitable for spawning. The channel was wide throughout with a lot of woody debris. There were large amounts of undercut banks that provided cover, but very few deep pools. Some steep eroding banks were seen in a few locations on the survey. Juvenile fish were spotted, in the culvert on Moore Road. Overall, the habitat was rated as
