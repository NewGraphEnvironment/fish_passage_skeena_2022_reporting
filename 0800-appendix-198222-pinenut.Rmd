...
`r fpr_my_habitat_paragraph(loc = 'us')` There is a collapsed bridge approximately 200m from crossing `r as.character(my_site)`. Some erosion was present along the sides of the bridge but there was no fish passage issue at the time of survey. There was a large woody debris jam 1.3m in height located approximately 500m upstream of the crossing. This obstacle would be passable for adult salmonids. Depending on flow conditions, this debris jam is likely a fish passage issue for the upstream migration of all life stages of resident populations as well as non-adult salmonids. This is a high energy system with numerous areas of multiple channels, islands and elevated bars. High flows were pushing most of the large woody debris out of the main channel, resulting in lower complexity. There were rare pockets of gravel suitable for spawning. Overall, the habitat surveyed upstream of the crossing was
