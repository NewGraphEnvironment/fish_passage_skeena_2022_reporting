...
\@ref(tab:tab-wshd-198236)). Upstream of crossing
...
priority for follow up by the Society for Ecosystem Restoration in Northern BC due to
significant amounts of habitat modeled upstream. A summary of habitat modelling outputs is presented in Table
