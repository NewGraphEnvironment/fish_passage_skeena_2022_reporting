...
\@ref(fig:plot-fish-box-8530). Dolly varden and cutthroat trout were caught both downstream and upstream of the culvert, while rainbow trout were only caught upstream `r if(gitbook_on){knitr::asis_output("(Figures \\@ref(fig:photo-8530-07) - \\@ref(fig:photo-8530-08)).")}else(knitr::asis_output("(Figure \\@ref(fig:photo-8530-u01))."))` 
