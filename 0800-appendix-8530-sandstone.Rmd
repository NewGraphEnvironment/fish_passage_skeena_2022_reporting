...
\@ref(fig:plot-fish-box-8530). Dolly varden and cutthroat trout were caught both downstream and upstream of the culvert, while rainbow trout were only caught upstream. 
...
fpr_table_fish_density(scroll = gitbook_on)
