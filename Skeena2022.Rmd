...
author: |
 ...
 |
 | Prepared by
 | Al Irvine, B.Sc., R.P.Bio. and Mateo Wintersheidt
...
The Gitxsan Laxyip (traditional territories) covers an area of 33,000km^2^ within the Skeena River and Nass River watersheds. The Laxyip is governed by 60 Simgiigyet (Hereditary Chiefs), within the traditional hereditary system made up of Wilps (House groups). Anaat are fisheries tenures found throughout the Laxyip. Traditional governance within a matrilineal society operates under the principles of Ayookw (Gitxsan law) [@GitxsanHuwilpGovernment2021]. Gitxsan means "People of the River Mist" in their native language. Its people reside in the communities of Hazelton, Kispiox and Glen Vowell (the Eastern Gitxsan bands) and Kitwanga, Kitwankool and Kitsegukla (the Western Gitxsan). The Gitxsan language is gradually being replaced by English, however some community schools still offer Gitxsan lessons. The original Gitxsan economy depended heavily on the trade of fish and other natural resources. The Gitxsan traded with neighbouring First Nations along "grease trails," which are routes named so because they carried the refined oil of the oolichan, a fish that resembles a smelt that is common in some areas of British Columbia and a major trading commodity among many First Nations, including the Gitxsan. They are also known for their range of traditional arts [@j_v_powelletal_GitxsanCanadian].
...
```{r hydrology-plot3, fig.cap = 'Hydrograph for Zymoetz River (Station #08EF005).', fig.show="hold", out.width= c("49.5%","1%","49.5%"), eval=T}
...
```{r hydrology-stats4, fig.cap = 'Summary of hydrology statistics for Zymoetz River (Station #08EF005 - Lat 54.116829 Lon -127.426582). Available daily discharge data from 1997 to 2021.', eval=T}
...
The Kispiox River watershed is a seventh order stream that drains an area of 2,088km^2^ in a south east direction. It is a large tributary of the Skeena River, contributing approximately 9% of its flow. It flows 140km to the confluence of the Skeena River, located near Kispiox Village. Elevations in the watershed range from 200m at the mouth to as high as 2090m on Kispiox Mountain. The mainstream of the Kispiox is fed mainly by glacier melt and high elevation snow melt. Swan and Stephens Lakes (located in the upper watershed), are the most important high fish value lakes. These lakes drain into the mainstem of the Kispiox River. Some of the biggest threats to aquatic ecosystems in the Kispiox valley include erosion, obstructions, sedimentation, and altered water yield. The upper third of the Kispiox watershed is well protected, containing few roads and forestry practices [@gottesfeld_etal2002ConservingSkeena]. The Kispiox River has a mean annual discharge estimated at `r round(fasstr::calc_longterm_mean(station_number = "08EB004")$LTMAD,1)` m^3^/s at station 08EB004 located near Hazelton. Peak discharge happens in May and June as a result of the spring snowmelt. (Figures \@ref(fig:hydrology-plot4) - \@ref(fig:hydrology-stats5)).

```{r hydrology-plot4, fig.cap = 'Hydrograph for Kispiox River near Hazelton (Station #08EB004).', fig.show="hold", out.width= c("49.5%","1%","49.5%"), eval=T}
...
```{r hydrology-stats5, fig.cap = 'Summary of hydrology statistics for Kispiox River near Hazelton (Station #08EB004). Available daily discharge data from 1963 to 2021.', eval=T}
...
About 100 km of the mainstem and 300 km of the tributary streams in the Kispiox River Watershed are designated high value fish habitat. They serve as a migration route and support spawning and rearing for many salmonids and other fish species. This fish community supports both recreational and commercial fishing while also enhancing the ecology, nutrient regime, and structural diversity of the drainage. It also creates strong cultural, economic, and symbolic ties, particularly for First Nation peoples. Since 1992, sockeye and coho escapements from the Kispiox Watershed have been documented by the Gitxsan Watershed Authorities [@gottesfeld_etal2002ConservingSkeena].

<br>

Salmon are a significant food source and cultural symbol for the Gitxsan people. Sockeye and coho have historically been the two most significant species for First Nations tribes. Gitangwalk and Lax Didax, two significant villages that were both abandoned in the early 1900s, were situated in such a way as to block the sockeye and coho salmon's upstream migration to the Upper Kispiox River spawning grounds. The Gitxsan were provided with the chance to gather and preserve a significant amount of high-quality food in a reasonably short period of time through intense work due to the plentiful and reliable sockeye salmon populations[@gottesfeld_etal2002ConservingSkeena].
