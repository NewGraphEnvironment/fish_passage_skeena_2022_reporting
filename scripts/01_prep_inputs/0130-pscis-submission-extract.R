...
targetdir = paste0(stub_from, '/Projects/PSCIS/phase1_submissions/PSCIS_skeena_2022_phase1/')
...
# here we transfer just the photos with labels over into the PSCIS directory where we will upload from to the gov interface
targetdir = paste0(stub_from, '/Projects/PSCIS/phase2_submissions/PSCIS_skeena_2022_phase2/')
dir.create(targetdir)
...
# here we transfer just the photos with labels over into the PSCIS directory where we will upload from to the gov interface
targetdir = paste0(stub_from, '/Projects/PSCIS/reassessments_submissions/PSCIS_skeena_2022_reassessments/')
dir.create(targetdir)
