...
xref_bcfishpass_names <- tibble::tribble(
                            ...
                            "all_rearing_belowupstrbarriers_km",                              "All Rearing Below Barriers (km)",     200L,       2L,                                                                                                             "Length of stream upstream of point and below any additional upstream barriers, modelled as potential rearing habitat (all CH,CO,SK,ST,WCT)",
                                               "all_rearing_km",                                             "All Rearing (km)",     200L,       1L,                                                                          "Length of stream upstream of point and below any additional upstream barriers, modelled as potential spawning habitat for all modelled species (currently BT,CH,CO,SK,ST,WCT)",
                           "all_spawning_belowupstrbarriers_km",                             "All Spawning Below Barriers (km)",     190L,       2L,                                                                                                                       "Length of stream upstream of point modelled as potential rearing habitat for all modelled species (currently BT,CH,CO,SK,ST,WCT)",
                                              "all_spawning_km",                                            "All Spawning (km)",     190L,       1L,                                                                                                                      "Length of stream upstream of point modelled as potential spawning habitat for all modelled species (currently BT,CH,CO,SK,ST,WCT)",
